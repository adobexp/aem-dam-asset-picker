...
| `ui.content` | `/content/asset-picker`, `/conf/asset-picker` CA samples, ACS Generic Lists, sample DAM at `/content/dam/asset-picker`. PackMgr requires `acs-aem-commons-ui.apps` 6.x. |
